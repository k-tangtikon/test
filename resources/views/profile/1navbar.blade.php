    ...
    <div class=" navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="javascript:void(0);" id="bt_about">
                    <div class="txtnav2">About</div>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="javascript:void(0);" id="bt_edu">
                    <div class="txtnav2">Education</div>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="javascript:void(0);" id="bt_work">
                    <div class="txtnav2">Experience</div>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="javascript:void(0);" id="bt_skills">
                    <div class="txtnav2">Skills</div>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="javascript:void(0);" id="bt_contact">
